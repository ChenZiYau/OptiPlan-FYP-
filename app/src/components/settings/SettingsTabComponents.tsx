...
import {
  Palette, Accessibility, Type,
  Save, RotateCcw, Check, Sun, Moon, Monitor, Mail,
} from 'lucide-react';
...
export type SettingsTab = 'appearance' | 'accessibility';

export const APPEARANCE_TABS: { key: SettingsTab; label: string; icon: typeof Palette }[] = [
  { key: 'appearance', label: 'Appearance', icon: Palette },
  { key: 'accessibility', label: 'Accessibility', icon: Accessibility },
];

export const TEXT_SCALE_OPTIONS: { key: TextScale; label: string }[] = [
  { key: 'sm', label: 'Small' },
  { key: 'md', label: 'Medium' },
  { key: 'lg', label: 'Large' },
...
export const COLOR_MODES: { key: ColorMode; label: string; icon: typeof Moon; bg: string; surface: string; text: string; border: string }[] = [
...
export function ToggleSwitch({ enabled, onChange, label, description }: { enabled: boolean; onChange: (v: boolean) => void; label: string; description: string }) {
  return (
...
export function UnsavedChangesBar({ hasChanges, onSave, onDiscard }: { hasChanges: boolean; onSave: () => void; onDiscard: () => void }) {
  return (
    <AnimatePresence>
      {hasChanges && (
        <motion.div
...
export function InputField({ label, icon: Icon, type = 'text', placeholder, value, onChange, disabled }: {
...
export function AppearanceTab() {
  ...
  return (
    ...
    >
      ...
      {/* Color Mode Selector */}
      <SectionCard title="Color Mode" description="Choose between dark, light, or grey background">
...
export function AccessibilityTab() {
  ...
  return (
    ...
    >
      ...
      <SectionCard title="Text Size" description="Adjust the base font size across the site">
