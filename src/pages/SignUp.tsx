        ...
        <div className="hidden lg:flex lg:w-1/2 flex-col justify-center px-16 xl:px-24">
          ...
          >
            ...
            <h1 className="font-display font-bold text-opti-text-primary leading-tight mb-6" style={{ fontSize: 'clamp(32px, 3.5vw, 52px)' }}>
              ...
              <br />
              <span className="text-gradient -mt-1 inline-block">Organized.</span>
            </h1>
            <p className="text-opti-text-secondary text-lg leading-relaxed max-w-lg">
              Stop switching between apps. OptiPlan unifies your schedule, studies,
              and budget into one intelligent platform designed for students and
              young professionals.
            </p>
            ...
            <motion.div custom={1} variants={fadeIn} className="glass-card p-8">
              <div className="mb-6">
                ...
                <p className="mt-2 text-sm text-opti-text-secondary">
                  ...
                  <Link to="/login" className="text-opti-accent hover:underline font-medium">
                    Sign In
                  </Link>
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <Label htmlFor="firstName" className="text-opti-text-primary mb-1.5">
                      First Name
                    </Label>
                    <Input
                      id="firstName"
                  ...
                  <div>
                    <Label htmlFor="lastName" className="text-opti-text-primary mb-1.5">
                      Last Name
                    </Label>
                    <Input
                      id="lastName"
                ...
                {/* Confirm Password */}
                <div>
                  <Label htmlFor="confirmPassword" className="text-opti-text-primary mb-1.5">
                    Confirm Password
                  </Label>
                  <div className="relative">
                    <Input
                ...
                <div>
                  <div className="flex items-start gap-2">
                    ...
                    <Label htmlFor="tos" className="text-sm text-opti-text-secondary font-normal leading-snug cursor-pointer">
                      I agree to the{' '}
                      <span className="text-opti-accent hover:underline cursor-pointer">Terms of Service</span>
                      {' '}and{' '}
                      <span className="text-opti-accent hover:underline cursor-pointer">Privacy Policy</span>
                    </Label>
                  </div>
